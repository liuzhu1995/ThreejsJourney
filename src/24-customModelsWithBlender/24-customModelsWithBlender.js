...
gui.add(directionalLight.position, 'x').min(-10).max(10).step(0.001).name('x')
gui.add(directionalLight.position, 'y').min(-10).max(10).step(0.001).name('y')
gui.add(directionalLight.position, 'z').min(-10).max(10).step(0.001).name('z')
